    ...
    do
    {
        ...
        switch(choice)
        {
            ...
            case '2':
             ...
             case '6':
                    cout<<endl<<"Enter The Name Of The Set In Which Insertion Is To Be Performed (A/B): ";
                    cin>>c;
                    if(c=='a' || c=='A')
                    {
             ...
             case '7':
                    cout<<endl<<"Enter The Name Of The Set Whose Element You Want To Delete (A/B): ";
                    cin>>c;
                    if(c=='a' || c=='A')
                    {
         ...
         case '8':
                    cout<<endl<<"Enter The Name Of The Set Whose Element You Want To Search (A/B): ";
                    cin>>c;
                    if(c=='a' || c=='A')
                    {
